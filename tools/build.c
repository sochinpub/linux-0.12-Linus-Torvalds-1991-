 ...
 * 使用该文件，将三个文件bootsect.S setup.S header.s创建成启动磁盘镜像。
 *
 * - bootsect: max 510 bytes of 8086 machine code, loads the rest
 * 最大510字节的8086机器代码（尾部是0x55AA两个字节结尾符号），用于加载其他代码。
 * - setup: max 4 sectors of 8086 machine code, sets up system parm
 * 最大4个扇区的8086机器代码，用来设置系统参数
...
#define MAJOR(a) (((unsigned)(a))>>8)	// 高8位major号
#define MINOR(a) ((a)&0xff)				// 低8位minor号
